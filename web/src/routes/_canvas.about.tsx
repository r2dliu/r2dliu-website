        ...
        <div className="flex flex-col min-h-full items-center justify-between">
          <div className="flex flex-col w-full">
            ...
            <div className="font-['HelveticaNeue'] text-xl w-full break-words">
              <p>
                I'm also a climber, hacker, Melee player, coach, fashion
                enthusiast, and much more.
              </p>
              <p>
                I'm obsessed with the concept of self improvement and pushing
                the limits of what I'm capable of. In the process, I've grown
                into a passionate, disciplined, and process-oriented architect
                who sees work and play as two sides of the same coin.
              </p>
              <p>
                ...
                conglomerate of various types of content. This is also the
                fourth time I've rebuilt it from scratch. That being said, it is
                my website, so I think it's okay if it grows into a bit of a
                hodgepodge collection of my many interests.
              </p>
