...
function Projects(props: NavigatingContextInterface & RouteComponentProps) {
	...
	const layout = [
		{ i: "hangman", x: 0, y: 0, w: 12, h: 3, static: true },
		{ i: "website", x: 12, y: 0, w: 12, h: 3, static: true },
		{ i: "scoreboard", x: 0, y: 3, w: 12, h: 3, static: true },
		{ i: "tableone", x: 12, y: 3, w: 12, h: 3, static: true }
	];
	return (
